---
title: "Chad Huntebrinker Module 14 Assignment"
...
Created a dataset representing a drug–target interaction network. The goal is to model the relationships between two different types of entities:
