---
title: "Chad Huntebrinker's Assignment 4"
...
The insight we've found is that there is a linear relationship between city fuel efficiency and highway fuel efficiency. As the city MPG increases, so does the highway.
...
It looks like Honda is the most fuel efficient company while Land Rover is the least. Also looks like there is negative relationship between highway MPG and engine displacement. As engine displacement increases, the highway mpg decreases. Finally it looks like compact cars are the most efficient car while pickups and SUVs are the least.